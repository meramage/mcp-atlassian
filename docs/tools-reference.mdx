...
description: "Overview of all 75 MCP tools for Jira and Confluence — organized by category with quick links"
---

MCP Atlassian provides **75 tools** for interacting with Jira and Confluence. Tools are organized by category below.
...
| Toolset | Core | Tools |
|---------|:----:|-------|
| `jira_issues` | Yes | `jira_get_issue`, `jira_search`, `jira_get_project_issues`, `jira_create_issue`, `jira_update_issue`, `jira_delete_issue`, `jira_batch_create_issues`, `jira_batch_get_changelogs`, `jira_get_issue_attachments`, `jira_download_attachment`, `jira_download_attachments`, `jira_get_issue_images` |
...
TOOLSETS=default,jira_agile,jira_links

# Enable all toolsets (75 tools)
TOOLSETS=all
